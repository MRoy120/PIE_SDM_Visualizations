...
low_SLR_erosion <- read_csv("data/scenario_2_crab_erosion/2021_Crab_Erosion_Low_SLR.csv") %>%
...
ggplot(data = low_SLR_erosion_2, 
  ...
  ggsave(filename = "figures/low_SLR_crab_erosion.png",
         width = 22,
         height = 15)
