...
moderate_SLR_base <- read_csv("data/scenario_1_baseline/2021_Baseline_Moderate_SLR.csv") %>%
...
ggplot(data = moderate_SLR_base_2, mapping = aes(x = time,
  ...
  labs(x = "Year",
       ...
       subtitle = "No Crab Erosion or Mitigation") +
  ...
  ggsave(filename = "figures/moderate_SLR_baseline.png",
         width = 22,
         height = 15)
