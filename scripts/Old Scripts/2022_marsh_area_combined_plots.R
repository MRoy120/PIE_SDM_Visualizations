...
total_crabs_erosion_plot <- ggplot(data = total_slr_erosion, 
                                   mapping = aes(x = time,
                                                 y = `Total Marsh`,
                                                 color = Scenario)) +
  geom_line(size = 6,
...
total_crabs_erosion_plot

ggsave(filename = "figures/total_slr_erosion.png",
       width = 30,
       height = 15)
...
total_crabs_growth_plot <- ggplot(data = total_slr_growth, 
                                  mapping = aes(x = time,
                                                y = `Total Marsh`,
                                                color = Scenario)) +
  geom_line(size = 6,
...
total_crabs_growth_plot

ggsave(filename = "figures/total_slr_growth.png",
       width = 30,
       height = 15)

ggpubr::ggarrange(plotlist = (list(total_crabs_erosion_plot,
                                   total_crabs_growth_plot)),
                  nrow = 2,
                  ncol = 1,
                  legend = "right")

ggsave(filename = "figures/erosion_growth_area_plots.png",
       width = 35,
       height = 30)
...
ggsave(filename = "figures/erosion_area_demand_plots.png",
       width = 35,
       height = 30)

ggpubr::ggarrange(plotlist = (list(total_crabs_growth_plot,
                                   total_crabs_growth_demand_plot)),
                  nrow = 2,
                  ncol = 1,
                  legend = "right")

ggsave(filename = "figures/growth_area_demand_plots.png",
       width = 35,
       height = 30)
